package com.example.learnbit.launch.student.home.category.subcategory.search;
...
public class SubcategorySearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subcategory_search);
    ...
    private void retrieveKey(){
        Query query = databaseReference.orderByChild("courseCategory").equalTo(subcategoryName);
